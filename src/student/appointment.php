...
<h2 class="p-3 my-2 text-4xl font-bold"> Appointment Scheduling</h2>
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:border-gray-300">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-black">Fill out the Form:</h5>
            <!-- Appointment Form Container -->
            <main class="flex items-center justify-center px-3 py-6">
                <div class="w-full max-w-3xl p-5">
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div class="flex justify-end">
                            <button type="submit"
                                class="px-6 py-3 text-white bg-teal-500 rounded-lg hover:bg-teal-600 focus:ring-4 focus:ring-teal-300 dark:focus:ring-teal-700">
