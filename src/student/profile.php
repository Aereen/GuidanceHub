...
<h2 class="p-3 my-2 text-4xl font-bold"> Profile </h2>
    <div class="grid-flow-row gap-6 p-5 my-5 border-2 rounded-lg lg:grid-cols-2 sm:grid-cols-4 dark:border-gray-700">

            <!-- Card 1 -->
            <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center space-x-6 lg:flex-row">
                    <!-- Profile Picture (Left) -->
                    <img src="/src/images/UMak-Facade-Admin.jpg" alt="Profile Picture" class="object-cover w-48 h-48 p-2 m-1 mb-4 rounded-full lg:mb-0 lg:order-first">
                    ...
                    <div class="w-full overflow-x-auto lg:w-2/3">
                        <table class="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400">
                            <tbody>
                                <tr>
                                    <th scope="row" class="px-6 py-3">NAME:</th>
                                    <td colspan="3">Eirene Grace Q. Armilla</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="px-6 py-3">STUDENT NO.:</th>
                                    <td colspan="3">A12035445</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="px-6 py-3">COLLEGE/INSTITUTE:</th>
                                    <td colspan="3">College of Computing and Information Sciences</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="px-6 py-3">YEAR LEVEL:</th>
                                    <td colspan="3">4th Year</td>
                                    <th scope="row" class="px-6 py-3">SECTION:</th>
                                    <td colspan="3">AINS</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <!-- Card 2 -->
                <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Appointment Scheduling</h5>
                </a>
