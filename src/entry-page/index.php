...
<header class="py-4 bg-yellow-400 shadow-md">
    <div class="container flex items-center justify-between px-4 mx-auto md:px-8">
        ...
        <div class="flex items-center space-x-4">
            ...
            <span class="text-lg font-bold md:text-xl">CounselPro</span>
        </div>
...
<section id="home" class="relative flex items-center justify-center text-center text-white bg-center bg-cover hero" 
    ...
    <div class="relative z-10 max-w-2xl px-4 py-8 md:px-8">
        ...
        <h1 class="text-5xl font-bold sm:text-7xl">Connect. Counsel. Care.</h1>
    </div>
</section>
    ...
    <div class="container mx-auto text-center">
        <h2 class="mb-8 text-3xl font-semibold">About Us</h2>
            <p class="max-w-4xl mx-auto text-lg">
                CounselPro is committed to providing students with the necessary tools to succeed academically and emotionally. Our team of professional counselors is here to support your journey through personal growth, mental health, academic success, and career development.
            </p>
    </div>
</section>
