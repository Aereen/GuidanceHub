...
<h2 class="text-2xl text-center font-bold">Referral Form</h2>
                ...
                <div id="tab2" class="hidden tab-content">
                    ...
                    <div class="mb-4">
                        <label for="reason" class="block text-sm font-medium text-gray-700">Reason for Referral
                           ...
                           <!-- MODAL -->
                            <div id="modal" class="fixed mx-auto inset-0 flex items-center justify-center hidden bg-gray-800 bg-opacity-50">
